// Sample data for inbox with extended details for modals - based on actual message structure
        ...
        function renderTable() {
            ...
            // Find the table within the active panel
            ...
            pageData.forEach((row, index) => {
                ...
                const globalIndex = startIndex + index; // This is the correct index in currentData
                const uniqueId = `${Date.now()}-${index}`; // Create unique ID for checkboxes
            ...
            // Find the info elements within the active panel
        ...
        function setupCheckboxHandlers() {
            ...
            panelConfigs.forEach(config => {
                ...
                if (!selectAll || !selectAllMobile) return;
    ...
    setTimeout(() => {
        ...
        class AccessibleTooltip {
            ...
            adjustPosition() {
                ...
                const padding = 10; // safety margin from viewport edge
                ...
                requestAnimationFrame(() => {
                    ...
                    // Check vertical overflow (for left/right positioned tooltips or if still overflowing)
                    requestAnimationFrame(() => {
